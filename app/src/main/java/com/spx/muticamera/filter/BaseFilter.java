...
public abstract class BaseFilter {
    static final String TAG = "flutter_BaseFilter";
...
//            0.9f, 0.0f,
    ...
    protected void initBuffer() {
        ByteBuffer a = ByteBuffer.allocateDirect(4 * pos.length);
        a.order(ByteOrder.nativeOrder());
        mVerBuffer = a.asFloatBuffer();
        mVerBuffer.put(pos);
        mVerBuffer.position(0);
        ByteBuffer b = ByteBuffer.allocateDirect(4 * coord.length);
...
//    }
    ...
    public void setTextureId_front(int textureId) {
        this.textureId_front = textureId;
    }
