...
public class SlideGpuFilterGroup {
    ...
    public SlideGpuFilterGroup() {
        initFilter();
        scroller = new Scroller(TmfApplication.Companion.getContext());
    }
    ...
    public void onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                locked = true;
                downX = -1;
                if (offset > TmfApplication.Companion.getScreenWidth() / 3) {
                    scroller.startScroll(offset, 0, TmfApplication.Companion.getScreenWidth() - offset, 0, 100 * (1 - offset / TmfApplication.Companion.getScreenWidth()));
                    needSwitch = true;
                } else {
                    scroller.startScroll(offset, 0, -offset, 0, 100 * (offset / TmfApplication.Companion.getScreenWidth()));
                    needSwitch = false;
                }
                break;
        }
