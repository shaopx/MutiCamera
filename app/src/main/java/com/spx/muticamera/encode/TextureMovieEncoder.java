...
import com.spx.muticamera.encode.gles.EglCore;
import com.spx.muticamera.filter.BaseFilter;
import com.spx.muticamera.filter.GPUImageFilter;
import com.spx.muticamera.filter.MagicCameraInputFilter;
...
public class TextureMovieEncoder implements Runnable {
    private static final String TAG = "tmf_TextureMovieEncoder";
    ...
    private static final int MSG_NEXT_FILE = 8;
    ...
    public void setEncodeCallback(EncodeCallback callback){
    ...
    public void switchNextOutputFile() {
        mHandler.sendMessage(mHandler.obtainMessage(MSG_NEXT_FILE));
    }
    /**
...
//        Log.e("hero", "---setTextureId==" + mTextureId);
    ...
    private void handleNextFile(){
        mVideoEncoder.switchToNextFile();
    }
...
//            type = MagicFilterType.NONE;
        ...
        Log.i(TAG, "releaseEncoder: ....encodeCallback:"+encodeCallback);
        if (encodeCallback != null) {
            encodeCallback.onFinishEncode(mVideoEncoder.getOuputPaths());
        }
    }

    //    private MagicFilterType type = MagicFilterType.NONE;
    private BaseFilter mShowFilter = new NoneFilter(TmfApplication.Companion.getContext().getResources());
